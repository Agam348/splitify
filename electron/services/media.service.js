...
function getFfprobePath() {
    ...
    return path.join(process.env.APP_ROOT, 'node_modules', '@ffprobe-installer', packageName, executable);
}
...
export class MediaService {
    async getVideoMetadata(filePath) {
        ...
        const videoStream = probe.streams?.find((stream) => stream.codec_type === 'video' && !stream.disposition?.attached_pic);
        ...
        const containerFormat = probe.format.format_long_name ?? probe.format.format_name;
